...
{
    public class SpeedAnalysisViewModel : MvxViewModel
    {
        ...
        public SpeedAnalysisViewModel(IMvxNavigationService navigationService)
        {
        ...
        public async void LoadGraphDataA()
        {
            ...
            try
            {
                ...
                ObservableCollection<SpeedDataPointModel>? wrappers =
                await JsonSerializer.DeserializeAsync<ObservableCollection<SpeedDataPointModel>>(stream);
                ...
                foreach (SpeedDataPointModel wrapper in wrappers)
                {
                    _obeservablePointsA.Add(new(wrapper.LapDistance, wrapper.SpeedMph));
                }
            }
            catch
            {
        ...
        public async void LoadGraphDataB()
        {
            ...
            try
            {
                ...
                foreach (SpeedDataPointModel wrapper in wrappers)
                {
                    _obeservablePointsB.Add(new(wrapper.LapDistance, wrapper.SpeedMph));
                }
            }
            catch
            {
