...
{
    public class TimeAnalysisViewModel : MvxViewModel
    {
        ...
        public TimeAnalysisViewModel(IMvxNavigationService navigationService)
        {
        ...
        public async void LoadGraphDataA()
        {
            ...
            try
            {
                ...
                ObservableCollection<TimeDataPointModel>? wrappers =
                await JsonSerializer.DeserializeAsync<ObservableCollection<TimeDataPointModel>>(stream);
                ...
                foreach (TimeDataPointModel wrapper in wrappers)
                {
                    _obeservablePointsA.Add(new(wrapper.LapDistance, wrapper.CurrentLapTime));
                }
            }
            catch
            {
        ...
        public async void LoadGraphDataB()
        {
            ...
            try
            {
                ...
                foreach (TimeDataPointModel wrapper in wrappers)
                {
                    _obeservablePointsB.Add(new(wrapper.LapDistance, wrapper.CurrentLapTime));
                }
            }
            catch
            {
